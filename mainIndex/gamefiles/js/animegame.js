...
button.addEventListener('click', function(){
    trivia = "https://opentdb.com/api.php?amount=1&category=31&type=multiple&difficulty=" + diffInput.value;
...
//  + [i-8]
            ...
            firstanswer.innerHTML = element.results[0].correct_answer
        ...
        answerButton.addEventListener('click', function(){
            ...
            if(ansInput.value == answer1.textContent){      //fix score board
                score = score+15;
