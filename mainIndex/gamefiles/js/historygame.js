...
button.addEventListener('click', function(){
    trivia = "https://opentdb.com/api.php?amount=1&category=23&type=multiple&difficulty=" + diffInput.value;
...
//  + [i-8]
            ...
            firstanswer.innerHTML = element.results[0].incorrect_answers[2];
            ...
            secondanswer.innerHTML = element.results[0].incorrect_answers[0]
            ...
            thirdanswer.innerHTML = element.results[0].incorrect_answers[1]
        ...
        answerButton.addEventListener('click', function(){
            ...
            if(ansInput.value == answer3.textContent){      //fix score board
                score = score+15;
